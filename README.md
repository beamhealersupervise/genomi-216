...
```bash
git clone https://github.com/beamhealersupervise/genomi-216.git
cd genomi-216
python setup.py
```
...
if anything below drifts from it, that doc wins.
   ...
   ```bash
   git clone git@github.com:beamhealersupervise/genomi-216.git ~/.genomi/genomi
   cd ~/.genomi/genomi
   ```
...
- [1000 Genomes 30x GRCh38](https://www.internationalgenome.org/data-portal/data-collections/30x-grch38.html) —
  ...
  the [genomi-ancestry-panel](https://github.com/beamhealersupervise/genomi-216-ancestry-panel)
...
<!-- Last updated: 2026-06-05 15:18:59 -->
